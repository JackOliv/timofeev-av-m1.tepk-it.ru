...
--
-- Хост: localhost
-- Время создания: Июн 10 2025 г., 09:23
...
CREATE TABLE `product_materials` (
  ...
  `need_quantity` decimal(18,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `product_materials` (`id`, `product_id`, `material_id`, `need_quantity`) VALUES
(1, 5, 10, 1.95),
(2, 12, 10, 0.21),
(3, 14, 18, 1.50),
(4, 18, 18, 1.00),
